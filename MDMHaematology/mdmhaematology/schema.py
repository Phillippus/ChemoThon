"""Pydantic schéma znalostnej databázy (knowledge base, KB) pre lymfómy.
...
class Entity(str, Enum):
    """Entity (moduly) — typy lymfómov."""

    HL = "hl"          # Hodgkinov lymfóm (klasický)
    DLBCL = "dlbcl"    # Difúzny veľkobunkový B-lymfóm
    FL = "fl"          # Folikulárny lymfóm
    MCL = "mcl"        # Lymfóm z plášťových buniek
    MZL = "mzl"        # Marginálnozónový lymfóm
    PTCL = "ptcl"      # Periférny T-bunkový lymfóm
