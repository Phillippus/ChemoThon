...
nekonzistentný reviewed stav, neznáma spoločnosť/entita...), vyhodí sa výnimka.
...
# Mapovanie súboru -> entita (pre kontrolu, že záznamy sedia do správneho súboru).
_KB_FILES = {
    Entity.ENDOMETRIUM: "endometrium.yaml",
    Entity.CERVIX: "cervix.yaml",
    Entity.VULVA: "vulva.yaml",
    Entity.OVARY: "ovary.yaml",
}
