"""Pydantic schéma znalostnej databázy (knowledge base, KB) pre sarkómy a NET.
...
class Society(str, Enum):
    ESMO = "ESMO"      # vrátane ESMO-EURACAN pre sarkómy
    NCCN = "NCCN"
    ENETS = "ENETS"    # European Neuroendocrine Tumor Society (pre NET)


class Entity(str, Enum):
    """Moduly — typy nádorov."""

    SOFT_TISSUE = "soft_tissue"  # Soft-tissue sarkóm
    GIST = "gist"                # Gastrointestinálny stromálny tumor
    BONE = "bone"                # Kostný sarkóm
    NET = "net"                  # Gastroenteropankreatický NET
