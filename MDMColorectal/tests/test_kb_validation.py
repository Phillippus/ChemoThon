"""Validačné testy znalostnej databázy (KB) — kolorektálny karcinóm.
...
from mdmcolorectal.entities import ENTITIES
from mdmcolorectal.kb_loader import load_kb
from mdmcolorectal.schema import UNVERIFIED_MARK, Recommendation
...
def test_missing_required_field_fails_validation():
    incomplete = {"id": "x", "entity": "colon", "society": "ESMO"}
...
def test_reviewed_true_without_reviewer_fails():
    with pytest.raises(Exception):
        Recommendation(
            id="x", entity="colon", society="ESMO",
